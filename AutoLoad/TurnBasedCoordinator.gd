...
#var battleBoardSelector: BattleBoardSelectorComponent3D:
	#get:
		...
		#return null
#
#@export_storage var playerInsectors: Array[BattleBoardUnitServerEntity]:
	#get:
...
#
#@export_storage var enemyInsectors: Array[BattleBoardUnitServerEntity]:
	#get:
...
#
	...
	#currentTeam = FactionComponent.Factions.player1 if currentTeam == 6 else FactionComponent.Factions.ai
	#
...
#func _startCoinflip() -> void:
	#var result := FactionComponent.Factions.player1 if randi() % 2 == 0 else FactionComponent.Factions.ai
